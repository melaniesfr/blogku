...
public class RecvK3Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recv_k3);
        ...
        recyclerView = findViewById(R.id.list_kategori3);
    ...
    private void getImageData() {
        databaseReference.orderByChild("idkategori").equalTo("3").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter.setOnItemClickListener(new PostAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(int position) {
                        ...
                        startActivity(new Intent(RecvK3Activity.this, DetailPostActivity.class).putExtra("judul", judul));
                    }
                });
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(RecvK3Activity.this, "Maaf terjadi kesalahan... coba beberapa saat lagi!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}