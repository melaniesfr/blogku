...
public class RecvK1Activity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_recv_k1);
        ...
        recyclerView = findViewById(R.id.list_kategori1);
    ...
    private void getImageData() {
        databaseReference.orderByChild("idkategori").equalTo("1").addListenerForSingleValueEvent(new ValueEventListener() {
            @Override
            public void onDataChange(@NonNull DataSnapshot dataSnapshot) {
                ...
                adapter.setOnItemClickListener(new PostAdapter.OnItemClickListener() {
                    ...
                    public void onItemClick(int position) {
                        ...
                        startActivity(new Intent(RecvK1Activity.this, DetailPostActivity.class).putExtra("judul", judul));
                    }
                });
            }
            ...
            public void onCancelled(@NonNull DatabaseError databaseError) {
                Toast.makeText(RecvK1Activity.this, "Maaf terjadi kesalahan... coba beberapa saat lagi!", Toast.LENGTH_SHORT).show();
            }
        });
    }
}